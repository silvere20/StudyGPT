                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs font-bold bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 px-2 py-1 rounded-md shrink-0 ml-2">{chaptersInTopic.length}</span>
                    </div>
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        isExpanded ? "border-orange-300 dark:border-orange-500 shadow-md" : "border-gray-200 dark:border-gray-700 shadow-sm hover:border-gray-300 dark:hover:border-gray-600"
                      )}
                    >
                      <div className="p-6">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-3">
                          <div className="flex-1">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100 leading-tight">{chapter.title}</h4>
                          </div>
                          <button
